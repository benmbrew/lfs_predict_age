...
train_file_name <- 'data/train_valid_big_model/'
test_file_name <- 'data/train_test_big_model/'
...
temp <- plot_results(folder_name = 'data/train_valid_big_model/', file_name ='ada_array_first_with_cov_pc_removal_keep_cancer_lfs_first_control_gender_no_scale_control_draw.csv', cutoff_value = .45, plot_var = 'age')
print(temp[[1]])
print(temp[[2]])

temp <- plot_results(folder_name = 'data/train_test_big_model/', file_name ='ada_array_first_with_cov_pc_removal_keep_cancer_lfs_first_control_gender_no_scale_control_draw.csv', cutoff_value = .45, plot_var = 'age')
print(temp[[1]])
print(temp[[2]])

#logit_array_first_with_cov_pc_removal_keep_cancer_lfs_first_control_gender_scale_data_no_draw.csv
temp <- plot_results(folder_name = 'data/train_valid_big_model/', file_name ='logit_array_first_with_cov_pc_removal_keep_cancer_lfs_first_control_gender_scale_data_no_draw.csv', cutoff_value = .125, plot_var = 'age')
print(temp[[1]])
print(temp[[2]])

temp <- plot_results(folder_name = 'data/train_test_big_model/', file_name ='logit_array_first_with_cov_pc_removal_keep_cancer_lfs_first_control_gender_scale_data_no_draw.csv', cutoff_value = .25, plot_var = 'age')
print(temp[[1]])
print(temp[[2]])
